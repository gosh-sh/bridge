...
| `IBridgeWithdrawalGroth16Verifier.sol` | Planned gnark 11-input Groth16 interface for Circuit 4 (single-final-root). Not in the tree; the live path is `IBridgeWithdrawalVerifier` / the SHPLONK aggregator. |
