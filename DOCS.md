...
| [`AGENTS.md`](AGENTS.md) | Context for agents and contributors: changelog policy, workspaces, the two directions, build and CI. Rewritten 2026-09-23 against the tree; its paths are current. |
