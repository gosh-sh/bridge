...
contract DepositIsolationTest is Test {
    ...
    function test_deposit_doesNotMutateVerifyBlockOrWithdrawState() public {
        ...
        assertEq(bridge.storedNumLayers(), layersBefore, "numLayers unchanged");
        ...
        assertEq(bridge.storedLayerHashes(0), l1Before, "layer hash unchanged");
