...
contract EthBeaconLightClient {
    ...
    ///         this. The embedded `ROTATE_VK_BLOB` already sets that flag, so on a
    ///         node running tvm-sdk#284+ an accepted rotate DOES enforce the folded
    ///         shard/step proofs. Until every validating node ships that opcode,
    ///         treat this path as a mechanism only: keep `_ownerRotationEnabled`
    ///         and do NOT call `disableOwnerRotation()`.
    ///
    ...
    //   sha256 bd108c08afb35668d2872e8a6dd65581fa8fcb06f2471ebd7c93d6ec7d21bab0
    ...
    bytes constant VK_BLOB =
        ...
        hex"f72f6a93d16cbecc1258c3a795d3953b8c214d812097aa07277e4ee0d1a1f010c69d56cda0e5e3d70e20f0b8bea988f4447799420dd139ac1ac1995f"
        hex"1e9a75aca01330e33dbdcf4ccabedd4bb0f09c64619cac86118ab8d0646c0585acc64352f2ee2ed3927fee4c2eb510f6112cb9da2a39546f0745047a"
    ...
    //   12 accumulator limbs against the SRS [s]·G2, so an accepted rotate is NOT
    //   yet trustless (see `submitRotate`). Keep the owner bootstrap path
    //   (`setCommitteeCommitment`) as the committee trust root and do NOT call
    //   `disableOwnerRotation()` until every validating node ships the opcode
    //   decider extension (tvm-sdk#284).
    //
