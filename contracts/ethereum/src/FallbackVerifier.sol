...
import "./IFallbackGroth16Verifier.sol";

/// @title FallbackVerifier
/// @notice Adapter that verifies Circuit 1B (Fallback attestation) proofs from
...
///      off-chain by `gnark-wrappers/circuit-1b` into a 256-byte Groth16
...
contract FallbackVerifier is IFallbackVerifier {
    ...
    constructor(address _groth16Verifier) {
        ...
        groth16Verifier = IFallbackGroth16Verifier(_groth16Verifier);
    }

    /// @inheritdoc IFallbackVerifier
