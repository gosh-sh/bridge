...
refuses with exit 3 instead, and that refusal is the procedure: reconcile
on chain first (advanced runbook, Case 3a), then follow what it says.
Either way the record stays.
