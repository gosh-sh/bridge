...
pub fn verify_primary_proof(
    ...
    verify_kzg_proof(&key_manager.srs, key_manager.primary_vk(), proof_bytes, instances)
}
...
pub fn verify_fallback_proof(
    ...
    verify_kzg_proof(key_manager.fallback.srs(), key_manager.fallback_vk(), proof_bytes, instances)
}
...
pub fn verify_layer_proof(
    ...
    verify_kzg_proof(key_manager.layer.srs(), key_manager.layer_vk(), proof_bytes, instances)
}
