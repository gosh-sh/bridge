...
//! 3. enriches it via [`bridge_event_witness::enrich_witness`] (events-tree +
//!    block-tree Merkle proofs + anchor),
//! 4. runs the C4 SHPLONK pipeline
//!    ([`crate::aggregator::Circuit4ShplonkPipeline`]) —
//!    [`crate::aggregator::InProcessCircuit4SnarkProver`] re-proves the witness
...
//!    the 24-instance SHPLONK calldata the deployed Yul verifier accepts
//!    byte-for-byte.
//!
...
pub use capture::{
    capture_next_withdrawal_event, capture_targeted_withdrawal_event, snapshot_baseline_msg_ids,
    CapturedEvent,
};
