...
| 3 — Solidity verifiers | Independent of partner | 🟢 In progress: 3.1 (Circuit 1B) and 3.2 (Circuit 1A) live, 16 Foundry tests green; 3.3 (Circuit 2) waits on Phase 1.B; 3.4 (Circuit 3) waits on Phase 1.C |
