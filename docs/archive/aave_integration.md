...
No AAVE interaction. Funds sit as ETH in `address(this).balance`.
...
Expected: 135 tests pass across 14 suites, no regressions in the deposit, layer-hash, BK rotation, oracle, or fuzz suites.
...
docs/aave_integration.md   (this file)
```
...
AGENTS.md, docs/integration_analysis.md, docs/integration_plan.md
```
