...
> 13 PI) verification flow. The v1 pipeline was retired in **Phase 4.2** (2026-05-10).
> The current canonical guide is `docs/verifying_an_proof.md` (v2, per-circuit).
> Preserved here as historical record for audit reproducibility of legacy proofs.
