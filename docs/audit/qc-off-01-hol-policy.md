...
**Ops:** [deposit-relayer-operator-runbook.md](deposit-relayer-operator-runbook.md).  
**Absorbed from:** GitHub [PR #40](https://github.com/gosh-sh/bridge/pull/40) into [PR #39](https://github.com/gosh-sh/bridge/pull/39).
