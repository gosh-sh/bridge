...
> **⚠ Testnet note (updated 2026-07).** Production Sepolia/shellnet bridges use **R15 SHPLONK aggregator** verifiers for 1A/1B/2/4. Identity-stub Groth16 is **test/CI only**. See [testnet_security_status.md](../testnet_security_status.md).
...
- EVM→AN deposit (orthogonal): `docs/operations/shellnet/shellnet_usdcbridge_deposit_vk_redeploy.md`
