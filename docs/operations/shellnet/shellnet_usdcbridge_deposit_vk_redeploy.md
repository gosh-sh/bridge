...
> Root cause + validation: `docs/zk/an-side/deposit_vk_witness_independence.md`.
...
| `docs/zk/an-side/zkhalo2verifywithvk_reference.md` §15 | VkBlob v2 `circuit_shape`, RLC reader |
...
the VK swap (code_hash `818fb76d…`). See `docs/zk/an-side/deposit_vk_witness_independence.md`
