...
**Status:** in progress.
**Deliverable:** `docs/zk/evm-side/r15_snark_verifier_roadmap.md` describing decision,
...
### M8. Cleanup
  ...
  - Update `AGENTS.md`, `docs/integration/an_partner_integration_plan.md` Decision
