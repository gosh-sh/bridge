...
| M5 — relayer | not started — gate-flip of `finalizeDeposit` onto this oracle waits for it (SLA + lag alert ~20 h). See [`docs/m5_eth_beacon_light_client.md`](docs/m5_eth_beacon_light_client.md) §Operational constraints |
