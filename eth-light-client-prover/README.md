...
| M5 — relayer | **landed** (`crates/eth-light-client-relayer`). Live loop: real committee from `light_client/updates`, `submit-rotate`, systemd **without** `--dry-run --mock-prove`. Flip: `scripts/ursus/flip_deposit_to_light_client.md`. Ancestry: `ancestry-one`. E2E: `scripts/ursus/eth_lc_shellnet_e2e.md`. |
